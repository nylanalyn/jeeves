...
class Replies(SimpleCommandModule):
    ...
    def __init__(self, bot):
        ...
        self.RE_HIDE = re.compile(rf"\b{name_pat}[,!\s]*\s*(hide|cloak|sneak|vanish|disappear|go\s+invisible)", re.IGNORECASE)
    ...
    def _handle_hide_request(self, connection, event, username: str):
